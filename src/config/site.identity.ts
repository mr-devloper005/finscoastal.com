export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'finscoastal',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Fins Coastal',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'finscoastal.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://finscoastal.com',
